...
public class MovieController {
    ...
    @ResponseBody
    public List<MoviePreviewDto> getMovieListJson(@RequestParam(required = false) String rating, @RequestParam(required = false) String price, @PathVariable int pageNumber) {
